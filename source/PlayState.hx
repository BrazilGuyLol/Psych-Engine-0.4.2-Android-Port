...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var creditTxt:FlxText = new FlxText(4,healthBarBG.y + 20,0,("Port by Brazil Guy"), 24);
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "Port by Brazil Guy", 32);
